...
#define SITE_URL "www.cs.pu.edu.tw/~yctsao"
#define FILE_NAME "/aaa.zip"
#define DOWNLOAD_FILENAME "bbb.txt"
...
//  LFile f = LFlash.open(DOWNLOAD_FILENAME, FILE_WRITE);
      // LFlash          // use Internal 10M Flash
  LFile f = Drv.open(DOWNLOAD_FILENAME, FILE_WRITE);
  Serial.print("Now open filen name is :(");
  Serial.print(DOWNLOAD_FILENAME) ;
  Serial.print(")\n");
  Serial.print("Now open file :(");
  Serial.print(f) ;
  Serial.print(")\n");
